...
const translations = {
  th: {
    ...
    heroTitle: 'พื้นที่ปลอดภัยของคุณ',
    ...
    crisisText1: 'เกือบ 1 ใน 10 คนไทย เสี่ยงต่อโรคซึมเศร้า และมีผู้เสียชีวิตจากการฆ่าตัวตายมากกว่า 5,000 คน ในปี 2567 (กรมสุขภาพจิต, มิ.ย 2568)',
  ...
  en: {
    ...
    crisisText1: 'Nearly 1 in 10 Thais are at risk of depression, with over 5,000 lives lost to suicide in 2024 (Department of Mental Health, June 2025).',
